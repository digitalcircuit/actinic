...
namespace G35_USB
{
	public abstract class AbstractAnimation
	{
		...
		/// <summary>
		/// Whether or not to apply smoothing to this <see cref="G35_USB.GenericAnimation"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets the requested animation delay for this <see cref="G35_USB.GenericAnimation"/> animation
		/// </summary>
		/// <value>
		...
		/// <summary>
		/// Gets a boolean indicating this <see cref="G35_USB.GenericAnimation"/> should be smoothly cross-faded to by the animation manager.
		/// </summary>
